...
//Upload image (relative path - ApiClient will prepend baseUrl)
  static const uploadImage = "/user/file-upload";
...
static String orderDateExtension({required String orderId}) {
  ...
  static String getNearestVendorlist="$baseUrl/vendor/nearest-all";
  ...
  static String getOrderDetails({required String orderId}) {
    return "$baseUrl/order/retrieve/specific/$orderId";
  }
