...
import 'package:local/app/view/screens/features/client/user_home/shop_details/product_details/category_wise_product/category_product_controller.dart';
  ...
  Widget buildHeader({required CategoryProductsController controller, required String categoryName, required String categoryImage, required RxList<dynamic> products}) {
    return ClipRRect(
