...
class ImageUploadWidget extends StatelessWidget {
  ...
  const ImageUploadWidget({super.key, required this.categoryController});
    ...
    return Center(
      child: Obx(() => Stack(
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: categoryController.imagePath.value.isEmpty
                      ...
                      : ClipRRect(
                          borderRadius: BorderRadius.circular(16),
                          child: categoryController.isNetworkImage.value
                              ? CustomNetworkImage(
                                  imageUrl: categoryController.imagePath.value,
                                  width: 160.w,
                                  height: 120.w,
              ...
              if (categoryController.imagePath.value.isNotEmpty)
                Positioned(
                  top: 8,
                  right: 8,
